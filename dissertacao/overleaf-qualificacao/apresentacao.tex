...
\begin{frame}{The Poisson process}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.78\textwidth]{figura-poisson}
  \end{figure}
  \vspace{-0.4em}
...
\begin{frame}{Transformers and the attention mechanism}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.72\textwidth]{figura-attention}
  \end{figure}
\end{frame}
...
\begin{frame}{Transformer Hawkes Process (THP)}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.44\textwidth}
      \centering
      \includegraphics[width=0.82\textwidth]{figura-thp}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Rotary Position Embedding (RoPE)}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.5\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figura-rope}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{HoTHP attention score (and keeping it stable)}
  ...
  \]
  The full score sums over the $d/2$ dimension pairs (index $p$):
  \[
    \resizebox{\textwidth}{!}{$
...
\begin{frame}{What the models learn: conditional intensities}
  \begin{columns}[T]
    \begin{column}{0.46\textwidth}
      \centering
      \includegraphics[height=0.72\textheight]{fig_model_intensity}
    \end{column}
    \begin{column}{0.52\textwidth}
      \small
...
% Invisible frame: needed to compile the \cite{}, never rendered
