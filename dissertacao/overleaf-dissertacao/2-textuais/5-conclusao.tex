...
\begin{enumerate}
    ...
    \item O parâmetro $\theta'$ controla uma única taxa de decaimento global. Processos com múltiplas escalas temporais (por exemplo, atividade diurna e semanal sobrepostas) podem requerer decaimentos distintos por cabeça de atenção ou por camada.
\end{enumerate}
