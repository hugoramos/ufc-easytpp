...
\documentclass[        
    ...
    brazil,           % Hifenizacoes em portugues
    spanish,          % Hifenizacoes em espanhol
    english,          % Ultimo idioma eh o idioma padrao do documento (ingles)
...
\nomedomestrado{Mestrado Acadêmico em Lógica e Inteligência Artificial}
...
\autor{Hugo Ramos Soares}
\titulo{HoTHP: Hyperbolic Rotary Position Embedding-based Transformer Hawkes Process for Length Extrapolation}
\data{2026}
\local{Fortaleza}
...
\orientadorcentro{Centro de Ciências e Tecnologia (CC)}
...
\coorientadorcentro{Centro de Ciências e Tecnologia (CC)}
...
\membrodabancadois{Prof. Dr. José Antônio Fernandes de Macêdo}
\membrodabancadoiscentro{Centro de Ciências e Tecnologia (CCT)}
\membrodabancadoisies{Universidade Federal do Ceará (UFC)}

\membrodabancatres{Prof. Dr. Diego Parente Paiva Mesquita}
\membrodabancatrescentro{Escola de Matemática Aplicada (EMAp)}
\membrodabancatresies{Fundação Getúlio Vargas (FGV)}
...
\begin{document}	
	...
	% \input{2-textuais/7-cronograma}
	
	%Elementos pós-textuais	
	\bibliography{3-pos-textuais/referencias,3-pos-textuais/zotero}
%	\imprimirglossario	
	\imprimirapendices
