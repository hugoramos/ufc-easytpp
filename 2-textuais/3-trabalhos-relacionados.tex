...
\begin{figure}
    ...
    \caption{As the extrapolation increases, we clearly see that the degradation shown by RoPE is smaller than that of traditional sinusoidal methods, but still much sharper than the model proposed by \citeonline{press_train_2021}}
