...
\section{Rotary Position Embeddings (RoPE) and the RoTHP}\label{sec:rothp}
    ...
    \begin{table}[h]
        \centering
        \caption{Model results by dataset}
        \label{tab:rothp_nll}
