...
Nos dados sintéticos gerados por processos de Hawkes com kernel exponencial, o HoTHP supera o RoTHP na maioria dos fatores de extrapolação testados, sendo uma vitória inequívoca após normalização dos dados. Esse resultado era esperado, pois o viés do modelo está perfeitamente alinhado com o processo gerador.
